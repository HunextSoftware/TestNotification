...
Silent è un valore booleano che indica se la notifica deve essere visibile solo all'interno dell'app oppure in tutti gli stati che passa l'applicazione.
